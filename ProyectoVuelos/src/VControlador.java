...
public class VControlador extends JFrame {// implements ActionListener
    ...
    private void agregarComponentes(){
        ...
        buttonInit.setBounds(20,400,400,30);//.setBounds(x, y, width, height)
        this.add(buttonInit);

        buttonInit.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                textAreaControlador.append("Press Iniciar /n");;
            }
        });

        buttonPause = new JButton("Pausar");
        buttonPause.setBounds(20,450,400,30);//.setBounds(x, y, width, height)
        this.add(buttonPause);

        buttonPause.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                textAreaControlador.append("Press Pausar /n");;
            }
        });

        buttonStop = new JButton("Detener");
        buttonStop.setBounds(20,500,400,30);//.setBounds(x, y, width, height)
        this.add(buttonStop);

        buttonStop.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                textAreaControlador.append("Press Detener /n");;
            }
        });
